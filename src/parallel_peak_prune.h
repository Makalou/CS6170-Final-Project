...
void reconstruct_graph(PPPVertex* d_vertices, PPPEdge* d_edges, PPPVertex* d_new_vertices, PPPEdge* d_new_edges, const int* d_peak_saddle_pairs,
    int* d_vet_should_remain, int* d_edge_should_remain, int* d_vet_remain_scan, int* d_vet_reorder_map, int v_size, int e_size, int* d_remain_v_size, int* d_remain_e_size);